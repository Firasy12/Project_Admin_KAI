...
<body class="flex h-screen overflow-hidden text-slate-800 bg-[#f4f6f9]">
    ...
    <aside class="w-64 kai-bg-navy flex flex-col shrink-0 z-20 shadow-2xl border-r border-slate-900/50">
        <div class="pt-8 pb-6 flex flex-col items-center justify-center px-6 border-b border-slate-800/60">
            ...
            <p class="text-[11px] text-center font-extrabold tracking-wide uppercase mt-1.5"><span class="kai-text-orange">PT KERETA API INDONESIA</span></p>
        </div>
        ...
        <header class="h-24 bg-white border-b border-slate-200/80 flex items-center justify-between px-8 shrink-0 shadow-sm relative z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs font-semibold text-slate-400 mt-0.5">Kelola dan unduh seluruh berkas persyaratan pendaftar magang.</p>
                </div>
            </div>
            <div class="flex items-center space-x-4">
                <div class="flex items-center bg-slate-50 border border-slate-200 rounded-2xl p-2 pr-5 shadow-inner">
                    <div class="w-9 h-9 rounded-xl kai-bg-navy text-white flex items-center justify-center font-black text-sm mr-3">AS</div>
            ...
            <div class="relative z-10 space-y-6">
                <div class="bg-white rounded-2xl border border-slate-200 shadow-md overflow-hidden transition-shadow hover:shadow-lg">
                    ...
                    <div class="p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-white relative">
                        ...
                        <h4 class="text-base font-extrabold text-[#0b1739] tracking-tight flex items-center gap-2"><i class="fa-solid fa-folder-tree text-slate-400"></i> Daftar Berkas Mahasiswa</h4>
                        <form action="" method="GET" class="relative w-full sm:w-80 group">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none"><i class="fa-solid fa-magnifying-glass text-slate-400 text-sm"></i></span>
                            <input type="text" placeholder="Cari nama/NIM/universitas..." class="w-full pl-10 pr-4 py-2 text-xs font-semibold bg-white border border-slate-200 rounded-xl focus:outline-none focus:border-[#f47920] focus:ring-1 focus:ring-[#f47920] shadow-inner">
                        </form>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="kai-bg-navy text-slate-300 text-[11px] font-bold uppercase tracking-wider border-b border-slate-800/80">
                                    ...
                                    <th class="px-6 py-4 text-center border-r border-slate-800/40">Proposal Pengajuan</th>
                            ...
                            <tbody class="text-sm text-slate-600 divide-y divide-slate-100 bg-white">
                                ...
                                <tr class="hover:bg-orange-50/10 even:bg-slate-50/40 transition-all duration-150">
                                    ...
                                    <td class="px-6 py-4 font-extrabold text-slate-800 text-[14px]">{{ $mock['nama'] ?? $row['nama'] }}</td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a href="#" class="inline-flex items-center gap-1.5 text-[11px] font-extrabold px-3 py-1.5 bg-rose-50 text-rose-600 border border-rose-200 rounded-xl hover:bg-rose-100 transition-colors shadow-sm">
                                            <i class="fa-solid fa-file-pdf text-rose-500"></i> Lihat PDF
                                        </a>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <a href="{{ url('/sdm/dokumen/detail') }}" class="inline-flex items-center gap-1.5 text-[11px] font-extrabold px-3 py-1.5 bg-cyan-50 text-cyan-700 border border-cyan-200 rounded-xl hover:bg-cyan-100 hover:text-cyan-800 transition-all shadow-sm">
