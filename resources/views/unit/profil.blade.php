...
<head>
    ...
    <title>Profil Pengguna - KAI Intern Management</title>
    ...
    <main class="flex-1 flex flex-col overflow-hidden relative">
        ...
        <header class="h-24 bg-white border-b border-slate-200/80 flex items-center justify-between px-8 shrink-0 shadow-sm relative z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-2xl font-black text-[#0b1739] tracking-tight">Profil Pengguna</h2>
            ...
            <div class="flex items-center space-x-4">
                <div class="flex items-center bg-slate-50 border border-slate-200 rounded-2xl p-2 pr-5 shadow-inner">
                    <div class="w-9 h-9 rounded-xl kai-bg-navy text-white flex items-center justify-center font-black text-sm tracking-wide mr-3 shadow-md">
                        AU
                    </div>
        ...
        {{-- AREA WORKSPACE DENGAN GRADASI FRESH CORPORATE LIGHT BLUE --}}
        <div class="flex-1 overflow-y-auto px-8 py-8 custom-scrollbar relative bg-gradient-to-br from-sky-200 via-blue-200 to-sky-300">
            ...
            <div class="absolute top-0 left-1/4 w-[400px] h-[400px] bg-blue-400/20 rounded-full blur-[120px] pointer-events-none z-0"></div>

            {{-- PROFIL MAIN CONTAINER LAYOUT SYSTEM --}}
            <div class="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                
                {{-- KARTU KIRI: AVATAR & RINGKASAN IDENTITAS (FIXED OVERLAP BUG) --}}
                <div class="bg-white rounded-2xl border border-blue-100/50 shadow-xl shadow-blue-950/10 p-6 flex flex-col items-center text-center relative overflow-hidden transition-all hover:shadow-2xl">
                    <div class="absolute -right-6 -top-6 w-24 h-24 bg-slate-50 rounded-full pointer-events-none"></div>
                    
                    {{-- Avatar Initial Wrapper --}}
                    <div class="w-24 h-24 rounded-full bg-gradient-to-br from-blue-50 to-blue-100 text-[#00529b] border-4 border-white shadow-xl flex items-center justify-center font-black text-2xl tracking-wide relative z-10 mb-4">
                        AU
                    </div>

                    {{-- User Meta Details --}}
                    <h4 class="text-base font-extrabold text-[#0b1739] tracking-tight">Admin Unit</h4>
                    <p class="text-xs font-bold text-slate-400 mt-1">Sistem Informasi</p>
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl border border-blue-100/50 shadow-xl shadow-blue-950/10 overflow-hidden transition-all hover:shadow-2xl">
                        ...
                        <form action="#" method="POST" class="p-6 space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="text" value="Admin Unit" class="w-full px-4 py-2.5 text-xs font-semibold bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-[#f47920] focus:ring-1 focus:ring-[#f47920] focus:bg-white shadow-inner transition-all">
                                </div>
                                {{-- Unit / Divisi --}}
                                <div class="space-y-1.5">
                                    <label class="text-xs font-extrabold text-slate-500 uppercase tracking-wide">Unit / Divisi</label>
                                    <input type="text" value="Sistem Informasi" class="w-full px-4 py-2.5 text-xs font-semibold bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-[#f47920] focus:ring-1 focus:ring-[#f47920] focus:bg-white shadow-inner transition-all">
                                </div>
                            </div>
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input type="email" value="admin.si@kai.id" class="w-full px-4 py-2.5 text-xs font-semibold bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-[#f47920] focus:ring-1 focus:ring-[#f47920] focus:bg-white shadow-inner transition-all">
                            </div>

                            {{-- Action Submit Button --}}
                            <div class="flex justify-end pt-2">
                                <button type="submit" class="kai-bg-navy hover:kai-bg-orange text-white text-xs font-extrabold px-5 py-2.5 rounded-xl shadow-md transition-all flex items-center gap-1.5">
                    ...
                    <div class="bg-white rounded-2xl border border-blue-100/50 shadow-xl shadow-blue-950/10 overflow-hidden transition-all hover:shadow-2xl">
                        ...
                        <form action="#" method="POST" class="p-6 space-y-4">
                            ...
                            <div class="flex justify-end pt-2">
                                <button type="submit" class="bg-rose-600 hover:bg-rose-700 text-white text-xs font-extrabold px-5 py-2.5 rounded-xl shadow-md transition-all flex items-center gap-1.5">
