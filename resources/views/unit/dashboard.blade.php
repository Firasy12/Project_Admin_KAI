    ...
    <main class="flex-1 flex flex-col overflow-hidden">
        ...
        <header
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-2xl font-black text-[#0b1739] tracking-tight">Selamat Datang, Unit Sistem Informasi
                    </h2>
                    <p class="text-xs font-semibold text-slate-400 mt-0.5">Kelola pengajuan magang mahasiswa di unit
                        Anda dengan mudah</p>
                </div>
            </div>
        ...
        <div
            ...
            <div class="relative z-10 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <div
                        class="bg-white rounded-2xl p-4 flex items-center justify-between shadow-xl shadow-blue-950/5 border border-blue-100/30 relative overflow-hidden transition-all duration-300 ease-out hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-blue-950/10 group">
                        ...
                        <div class="flex items-center gap-3.5 relative z-10">
                            ...
                            <div>
                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-wider">Tugas Masuk
                                </p>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3.5 relative z-10">
                            ...
                            <div>
                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-wider">Perlu Review
                                </p>
                                <h3 class="text-2xl font-black text-[#0b1739] mt-0.5 tracking-tight">
                                    {{ $jumlah_masuk ?? 0 }}</h3>
                            </div>
                    ...
                    <div
                        class="bg-white rounded-2xl p-4 flex items-center justify-between shadow-xl shadow-blue-950/5 border border-blue-100/30 relative overflow-hidden transition-all duration-300 ease-out hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-blue-950/10 group">
                        <div
                            class="absolute -right-4 top-1/2 -translate-y-1/2 w-24 h-24 bg-cyan-50/60 rounded-full transition-transform duration-500 ease-out group-hover:scale-125 pointer-events-none z-0">
                        </div>

                        <div class="flex items-center gap-3.5 relative z-10">
                            <div
                                class="w-12 h-12 rounded-2xl bg-cyan-500 text-white flex items-center justify-center text-xl shrink-0 shadow-lg shadow-cyan-500/20 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
                        ...
                        <span
                            class="text-[10px] font-black px-2.5 py-1 bg-cyan-100 text-cyan-700 border border-cyan-200 rounded-lg shadow-sm uppercase tracking-wide relative z-10 transition-colors group-hover:bg-cyan-600 group-hover:text-white group-hover:border-transparent">Alumni</span>
                    </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <button
                            class="kai-bg-navy hover:kai-bg-orange text-white px-4 py-2 rounded-xl text-xs font-bold transition-all shadow-md">
                            Lihat Semua
                        </button>
                    </div>
                                    ...
                                    @foreach($pengajuan_baru as $item)
                                        <tr class="hover:bg-slate-50/80 transition-colors">
                                            ...
                                            <td class="px-6 py-4 text-center">
                                                <span
                                                    class="inline-flex items-center gap-1.5 text-[11px] font-extrabold px-3 py-1 bg-amber-50 text-amber-600 border border-amber-200 rounded-lg uppercase tracking-wider shadow-sm">
                                ...
                                @else
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center text-slate-400">
                                            <div
                                                class="w-12 h-12 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center mx-auto mb-3 text-slate-300 shadow-inner">
                                                <i class="fa-solid fa-inbox text-xl"></i>
                                            </div>
                                            <p class="font-bold text-sm text-slate-500">Belum ada mahasiswa yang diteruskan
                                                dari SDM.</p>
                                        </td>
                                    </tr>
                                @endif
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Status Unit -->
                    <div
                        class="bg-white rounded-2xl p-6 shadow-xl shadow-blue-950/10 border border-blue-100/50 flex flex-col justify-between min-h-[220px]">
                        <div class="border-l-4 border-l-[#f47920] pl-3">
                            <h5 class="text-sm font-extrabold text-[#0b1739] tracking-tight uppercase">Status Unit Anda
                            </h5>
                        </div>
                        <div class="flex items-center gap-8 py-2">
                            <div class="relative flex items-center justify-center shrink-0">
                                <div
                                    class="w-24 h-24 rounded-full border-[10px] border-blue-600 border-l-emerald-500 border-t-emerald-500 flex items-center justify-center bg-slate-50/50 shadow-md">
                                    <i class="fa-solid fa-chart-pie text-slate-400 text-lg"></i>
                                </div>
                            </div>
                            <div class="space-y-2 text-xs font-bold text-slate-600">
                                <div class="flex items-center"><span
                                        class="w-3 h-3 rounded-md bg-blue-600 mr-2.5 shadow-sm"></span> Menunggu Review
                                    ({{ $jumlah_masuk ?? 0 }})</div>
                                <div class="flex items-center"><span
                                        class="w-3 h-3 rounded-md bg-emerald-500 mr-2.5 shadow-sm"></span> Sudah
                                    Diproses ({{ ($countDiterima ?? 0) + ($countDitolak ?? 0) }})</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            <div class="border-l-4 border-l-[#00529b] pl-3 mb-4">
                                <h5 class="text-sm font-extrabold text-[#0b1739] tracking-tight uppercase">Aktivitas
                                    Terbaru</h5>
                            </div>
                            <div class="space-y-3">
                                @if(isset($jumlah_masuk) && $jumlah_masuk > 0)
                                    <div
                                        class="flex gap-3.5 p-4 bg-gradient-to-r from-rose-50/50 to-white rounded-xl border border-rose-100 shadow-sm border-l-4 border-l-rose-500">
                                        <i class="fa-solid fa-circle-exclamation text-rose-500 text-base mt-0.5"></i>
                                        <div>
                                            <p class="text-xs font-black text-rose-800 uppercase tracking-wide">Tindakan
                                                Diperlukan</p>
                                            <p class="text-[11px] text-rose-600 font-semibold mt-1">Terdapat
                                                {{ $jumlah_masuk }} pengajuan baru yang memerlukan tindakan penempatan
                                                segera!</p>
                                        </div>
                                    </div>
                                @else
                                    <div
                                        class="flex gap-3.5 p-4 bg-gradient-to-r from-emerald-50/50 to-white rounded-xl border border-emerald-100 shadow-sm border-l-4 border-l-emerald-500">
                                        <i class="fa-solid fa-circle-check text-emerald-500 text-base mt-0.5"></i>
                                        <div>
                                            <p class="text-xs font-black text-emerald-800 uppercase tracking-wide">Sistem
                                                Bersih</p>
                                            <p class="text-[11px] text-emerald-600 font-semibold mt-1">Semua tugas
                                                penempatan berkas mahasiswa telah diselesaikan.</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl shadow-blue-950/10 border border-blue-100/50 p-6">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="{{ route('unit.export.pdf') }}" target="_blank" class="inline-flex items-center gap-2 px-5 py-3 rounded-xl
                      ...
                      transition-all duration-300 hover:-translate-y-1">
                            ...
                            <a href="{{ route('unit.export.excel') }}" target="_blank" class="inline-flex items-center gap-2 px-5 py-3 rounded-xl
